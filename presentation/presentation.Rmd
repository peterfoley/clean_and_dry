...
.pull-left[
![boy_thinking](photos/boy_thinking.jpg)
]
--
.pull-right[
...
.center[
<div style="font-size:250%"><br>BUT</div>
<div style="font-size:200%"><br>Packages take work</div>
<div style="font-size:150%"><br>and I just have a few scripts</div>
<div style="font-size:100%"><br>to share with just few people</div>
<div style="font-size:75%"><br>and I don't want to have to install it</div>
<div style="font-size:66%"><br>and please don't make me pick a name</div>
]
